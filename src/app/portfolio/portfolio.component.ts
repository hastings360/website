  ...
  constructor() {
    this.items = [
      ...
      },
      {
        ...
        description:
          // tslint:disable-next-line:max-line-length
          'An Angular app for recipe sharing named after my aunt Lulu!!. On the backend, this uses MongoDB, Express, Node, and a NGINX web server hosted on Red Hat Linux in the AWS cloud.      ',
        shapeClass: 'square',
